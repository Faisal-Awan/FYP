...
export const protectedRoutes = [
    {
        ...
        component: React.lazy(() => import('views/app-views/dashboards/default2')),
    },
    {
    ...
    },
    {
        key: 'apps.mail',
        path: `${APP_PREFIX_PATH}/apps/*`,
        component: React.lazy(() => import('views/app-views/apps/courses')),
    },
    {
        key: 'apps.chat',
        path: `${APP_PREFIX_PATH}/apps/testItem/*`,
        component: React.lazy(() => import('views/app-views/apps/testItem')),
    },
    {
        key: 'apps.calendar',
        path: `${APP_PREFIX_PATH}/apps/result`,
        component: React.lazy(() => import('views/app-views/apps/result')),
    },
    {
        key: 'apps.project',
